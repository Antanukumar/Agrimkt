...
if (isset($_GET['md'])) {
    $mid = $_GET['md'];
    $sql = "SELECT *  from  agriproduct where prodid='$mid'";
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table id="zero_config" style="padding-right: 0px; padding-left: 0px;" class="table table-hover">
                        ...
                        <tbody>
                            <?php
                            $sql = "SELECT *  from  price_table where product='$mid' limit 6";
                            ...
                            while ($rowp = mysqli_fetch_array($result)) {
                                ...
                                $pdate = $rowp['pdate'];
                                $mandi = $rowp['mandi'];
                                $sqlll = "SELECT *  from  mandi where mcode='$mandi'";
                                $resulttt = $conn->query($sqlll);
                                $rowppp = mysqli_fetch_array($resulttt);
                                $dist = $rowppp['district'];
